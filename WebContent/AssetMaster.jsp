  ...
  $('.edit').click(function (e) {
	  ...
	  if(tablerow == 0){
			     		...
			     		$.each(data, function(key,value){
			     			if(value.assetid == rowno){
			     				$('#closebutton').css("display","none");
					     			...
					     			+'<form action="AddAssetServlet" method="post" id="editform" style="display: block;">'+'<div class="row">'+'<div class="form-group">'
					     			+'<div class="col-md-6" style="display: none;">'
					     			+'<input type = "hidden" name = "id" style="visibility: hidden;" value="'+value.assetid+'"></input>'
					     		    ...
					     		    +'<input type="text" name="assetdes" class="form-control" placeholder="Qualification Description"value=\"'+value.assetdes+'\" required/>'+'</div>'
					     		    +'</div>'+'</div></div>'
		  ...
		  /* var name = $('#groupName').val(); */
			  	$.ajax({
					     type: "POST",
					     data:{action:$('#groupName').val(),group:"group"},
					     url: "AssetServlet",
					     dataType : "json",
					     async: true,
					     success: function(data){
 ...
 $(document).ready(function(){
	$.ajax({
	     ...
	     success: function(data){
	     	...
	     	var out = '';
	     		$.each(data, function(key,value){
	     			out = out + '<tr><td id = '+value.assetid+'><input type="checkbox" name="selrow" value = '+value.assetid+'></td><td>'+value.assetdes+'</td></tr>';
	     		})
...
<center>
  <h2 ><a href="MainMaster.jsp" style="color: #7F0A97">Asset Master</a></h2>
  </center>
...
<div class="wrap push" style="left: 0px; transition: left 300ms ease;">
    ...
    <form class="displayform" action="AddAssetServlet" method="post" style="display: block;">
    ...
    <input type="text" name="assetdes" class="form-control" placeholder="Qualification Description" required/>
    </div>
