			     		...
			     		$.each(data, function(key,value){
			     			if(value.branchid == rowno){
			     				$('#closebutton').css("display","none");
					     			...
					     			+'<form action="AddBranchServlet" method="post" id="editform" style="display: block;">'+'<div class="row">'+'<div class="form-group">'
					     			+'<div class="col-md-6" style="display: none;">'
					     			+'<input type = "hidden" name = "id" style="visibility: hidden;" value="'+value.branchid+'"></input>'
					     		    ...
					     		    +'</div>'
					     		   	+'<div class="col-md-6">'+'<label>Branch Name:</label>'
					     		    +'<input type="text" name="branchname" class="form-control" placeholder="Branch Name"value=\"'+value.branchdes+'\" required/>'+'</div>'
					     		    +'</div>'+'</div></div>'
 ...
 $(document).ready(function(){
	$.ajax({
	     ...
	     success: function(data){
	     	...
	     	var out = '';
	     		$.each(data, function(key,value){
	     			out = out + '<tr><td id = '+value.branchid+'><input type="checkbox" name="selrow" value = '+value.branchid+'></td><td>'+value.groupname+'</td>';
	     			out = out + '<td>'+value.companyname+'</td>'+ '<td>'+value.branchdes+'</td></tr>';
	     		})
...
<center>
  <h2 ><a href="MainMaster.jsp" style="color: #7F0A97">Branch/Site Master</a></h2>
  </center>
...
<div class="wrap push" style="left: 0px; transition: left 300ms ease;">
    ...
    <form class="displayform" action="AddBranchServlet" method="post" style="display: block;">
